...
En Vietnam también se usaron otros modelos de dron como el Ryan Firebee\ref{fig:ryanfirebee} que introdujo una nueva idea, la cámara de fotos para espiar al bando contrario.
...
\item Manuel Zafra\cite{manuelZafra} \footnote{\url{http://jderobot.org/Mazafrav-pfc}} trabajó en la localización del dron mediante April Tags y seguimiento de trayectorias. El objetivo de éste era recorrer autónomamente una ruta tridimensional en interiores, como secuencia de puntos 3D para lo que necesitaba estar localizado. Gracias a las April Tags que detectaba el dron podía estimar la posición 3D en el que estaba situado.
...
movimientos de vuelo. Por otro lado sobre simulador programó varias aplicaciones de control
